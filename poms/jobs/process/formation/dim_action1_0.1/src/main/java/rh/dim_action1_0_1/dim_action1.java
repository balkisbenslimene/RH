 ...
 * @status
 */
public class dim_action1 implements TalendJob {
	...
	private final String jobName = "dim_action1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_action1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class INSERT_DIM_ACTIONStruct implements routines.system.IPersistableRow<INSERT_DIM_ACTIONStruct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_RH_dim_action1.length) {
					if (length < 1024 && commonByteArray_RH_dim_action1.length == 0) {
						commonByteArray_RH_dim_action1 = new byte[1024];
					} else {
						commonByteArray_RH_dim_action1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_RH_dim_action1, 0, length);
				strReturn = new String(commonByteArray_RH_dim_action1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_RH_dim_action1) {
		 ...
		 * Compare keys
		 */
		public int compareTo(INSERT_DIM_ACTIONStruct other) {
	...
	public static class ou1Struct implements routines.system.IPersistableRow<ou1Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(ou1Struct other) {
	...
	public static class OU2Struct implements routines.system.IPersistableRow<OU2Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU2Struct other) {
	...
	public static class OU3Struct implements routines.system.IPersistableRow<OU3Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU3Struct other) {
	...
	public static class OU4Struct implements routines.system.IPersistableRow<OU4Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU4Struct other) {
	...
	public static class OU5Struct implements routines.system.IPersistableRow<OU5Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU5Struct other) {
	...
	public static class OU6Struct implements routines.system.IPersistableRow<OU6Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU6Struct other) {
	...
	public static class OU7Struct implements routines.system.IPersistableRow<OU7Struct> {
		final static byte[] commonByteArrayLock_RH_dim_action1 = new byte[0];
		static byte[] commonByteArray_RH_dim_action1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(OU7Struct other) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ou1Struct ou1 = new ou1Struct();

				row2Struct row2 = new row2Struct();
				OU2Struct OU2 = new OU2Struct();

				row3Struct row3 = new row3Struct();
				OU3Struct OU3 = new OU3Struct();

				row4Struct row4 = new row4Struct();
				OU4Struct OU4 = new OU4Struct();

				row5Struct row5 = new row5Struct();
				OU5Struct OU5 = new OU5Struct();

				row6Struct row6 = new row6Struct();
				OU6Struct OU6 = new OU6Struct();

				row7Struct row7 = new row7Struct();
				OU7Struct OU7 = new OU7Struct();

				row8Struct row8 = new row8Struct();
				INSERT_DIM_ACTIONStruct INSERT_DIM_ACTION = new INSERT_DIM_ACTIONStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "INSERT_DIM_ACTION");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("dim_action");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dim_action");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Xqijd29WjmzF6Og5O+jp0g7WonwoQ3Gn0o2Y7Xdh2SakXQ==");
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"Numero_d_action\" = ?,\"Intitule_de_l_action\" = ? WHERE ";
...
// # Outputs initialization
				INSERT_DIM_ACTIONStruct INSERT_DIM_ACTION_tmp = new INSERT_DIM_ACTIONStruct();
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "OU5", "OU6", "OU7", "OU2", "OU4",
							"ou1", "OU3");
				}
...
// ###############################
// # Outputs initialization
				ou1Struct ou1_tmp = new ou1Struct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Hpa2YkwrfiOcd/lOIktk1cQxiDtG0w1lDbNK/Q==");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.nb_d_heures = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Organisme_Formateurs";

									row1.Organisme_Formateurs = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Organisme_Formateurs = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Cout__HT = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Cout__HT = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// # Output table : 'ou1'
									ou1_tmp.Num_action = row1.Num_action;
									ou1_tmp.Intitule_de_l_action = row1.Intitule_de_l_action;
									ou1 = ou1_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = ou1.Num_action;
									row8.Intitule_de_l_action = ou1.Intitule_de_l_action;
...
//////////
									...
									{ // start of Var scope
										...
										INSERT_DIM_ACTION = null;

// # Output table : 'INSERT_DIM_ACTION'
										INSERT_DIM_ACTION_tmp.Numero_d_action = row8.Num_action;
										INSERT_DIM_ACTION_tmp.Intitule_de_l_action = row8.Intitule_de_l_action;
										INSERT_DIM_ACTION = INSERT_DIM_ACTION_tmp;
// ###############################
									 ...
									 */
// Start of branch "INSERT_DIM_ACTION"
									if (INSERT_DIM_ACTION != null) {
										...
										if (INSERT_DIM_ACTION.Numero_d_action == null) {
											pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
										} else {
											pstmtUpdate_tDBOutput_1.setInt(1, INSERT_DIM_ACTION.Numero_d_action);
										}

										if (INSERT_DIM_ACTION.Intitule_de_l_action == null) {
											pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmtUpdate_tDBOutput_1.setString(2,
													INSERT_DIM_ACTION.Intitule_de_l_action);
										}
											...
											if (updateFlag_tDBOutput_1 == 0) {
												...
												if (INSERT_DIM_ACTION.Numero_d_action == null) {
													...
													pstmtInsert_tDBOutput_1.setInt(1,
															INSERT_DIM_ACTION.Numero_d_action);
												}
									...
									} // End of branch "INSERT_DIM_ACTION"
...
// ###############################
// # Outputs initialization
				OU2Struct OU2_tmp = new OU2Struct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:lvlJtsqcaqjVAMqmO9U6bL2F5javEjyN2u16jA==");
						...
						for (int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
									...
									row2.nb_de_jours = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null,
											'.' == decimalChar_tFileInputExcel_2 ? null
													: decimalChar_tFileInputExcel_2));
								} else {
								...
								if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
									curColNum_tFileInputExcel_2 = columnIndex_tFileInputExcel_2
											+ start_column_tFileInputExcel_2 + 1;
									curColName_tFileInputExcel_2 = "Organisme_Formateurs";

									row2.Organisme_Formateurs = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
								} else {
									row2.Organisme_Formateurs = null;
									emptyColumnCount_tFileInputExcel_2++;
								}
...
// # Output table : 'OU2'
									OU2_tmp.Num_action = row2.Num_action;
									OU2_tmp.Intitule_de_l_action = row2.Intitule_de_l_action;
									OU2 = OU2_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU2.Num_action;
									row8.Intitule_de_l_action = OU2.Intitule_de_l_action;
...
// ###############################
// # Outputs initialization
				OU3Struct OU3_tmp = new OU3Struct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:8Cd4F3H12fm2Br9p1o1mEAOsrDsU/pek9kFfdQ==");
						...
						for (int i_tFileInputExcel_3 = begin_line_tFileInputExcel_3; i_tFileInputExcel_3 < end_line_tFileInputExcel_3; i_tFileInputExcel_3++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
									...
									row3.nb_d_heures = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], null,
											'.' == decimalChar_tFileInputExcel_3 ? null
													: decimalChar_tFileInputExcel_3));
								} else {
								...
								if (temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
									curColNum_tFileInputExcel_3 = columnIndex_tFileInputExcel_3
											+ start_column_tFileInputExcel_3 + 1;
									curColName_tFileInputExcel_3 = "Organisme__Formateurs";

									row3.Organisme__Formateurs = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
								} else {
									row3.Organisme__Formateurs = null;
									emptyColumnCount_tFileInputExcel_3++;
								}
								...
								if (temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
									...
									row3.Cout__HT = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
								} else {
									row3.Cout__HT = null;
									emptyColumnCount_tFileInputExcel_3++;
								}
...
// # Output table : 'OU3'
									OU3_tmp.Num_action = row3.Num_action;
									OU3_tmp.Intitule_de_l_action = row3.Intitule_de_l_action;
									OU3 = OU3_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU3.Num_action;
									row8.Intitule_de_l_action = OU3.Intitule_de_l_action;
...
// ###############################
// # Outputs initialization
				OU4Struct OU4_tmp = new OU4Struct();
// ###############################
...
//end%>
							...
							try {
								...
								if (temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
									curColNum_tFileInputExcel_4 = columnIndex_tFileInputExcel_4
											+ start_column_tFileInputExcel_4 + 1;
									curColName_tFileInputExcel_4 = "Organisme__Formateurs";
									row4.Organisme__Formateurs = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
								} else {
									row4.Organisme__Formateurs = null;
									emptyColumnCount_tFileInputExcel_4++;
								}
...
// # Output table : 'OU4'
									OU4_tmp.Num_action = row4.Num_action;
									OU4_tmp.Intitul__de_l_action = row4.Intitul__de_l_action;
									OU4 = OU4_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU4.Num_action;
									row8.Intitule_de_l_action = OU4.Intitul__de_l_action;
...
// ###############################
// # Outputs initialization
				OU5Struct OU5_tmp = new OU5Struct();
// ###############################
...
//end%>
							...
							try {
								...
								if (temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
									curColNum_tFileInputExcel_5 = columnIndex_tFileInputExcel_5
											+ start_column_tFileInputExcel_5 + 1;
									curColName_tFileInputExcel_5 = "nb_jours_total";
									row5.nb_jours_total = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
								} else {
									row5.nb_jours_total = null;
									emptyColumnCount_tFileInputExcel_5++;
								}
								...
								if (temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
									curColNum_tFileInputExcel_5 = columnIndex_tFileInputExcel_5
											+ start_column_tFileInputExcel_5 + 1;
									curColName_tFileInputExcel_5 = "nb_d_heures_total";
									row5.nb_d_heures_total = ParserUtils
											.parseTo_Integer(temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5]);
								} else {
									row5.nb_d_heures_total = null;
									emptyColumnCount_tFileInputExcel_5++;
								}
								...
								if (temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
									curColNum_tFileInputExcel_5 = columnIndex_tFileInputExcel_5
											+ start_column_tFileInputExcel_5 + 1;
									curColName_tFileInputExcel_5 = "Organisme__Formateurs";
									row5.Organisme__Formateurs = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
								} else {
									row5.Organisme__Formateurs = null;
									emptyColumnCount_tFileInputExcel_5++;
								}
								...
								if (temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5].length() > 0) {
									...
									row5.Co_t__HT = temp_row_tFileInputExcel_5[columnIndex_tFileInputExcel_5];
								} else {
									row5.Co_t__HT = null;
									emptyColumnCount_tFileInputExcel_5++;
								}
...
// # Output table : 'OU5'
									OU5_tmp.Num_action = row5.Num_action;
									OU5_tmp.Intitul__de_l_action = row5.Intitul__de_l_action;
									OU5 = OU5_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU5.Num_action;
									row8.Intitule_de_l_action = OU5.Intitul__de_l_action;
...
// ###############################
// # Outputs initialization
				OU6Struct OU6_tmp = new OU6Struct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_6 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Sf7gR3G4fmWGBDBy5ErqLaSAjiEJk3AUa01h8A==");
				...
				try {
					...
					sheetList_tFileInputExcel_6.addAll(
							regexUtil_tFileInputExcel_6.getSheets(workbook_tFileInputExcel_6, "Plan d'action", false));
					...
					if (sheetList_tFileInputExcel_6.size() > 0) {
						...
						for (int i_tFileInputExcel_6 = begin_line_tFileInputExcel_6; i_tFileInputExcel_6 < end_line_tFileInputExcel_6; i_tFileInputExcel_6++) {
							...
							row6 = null;
							int tempRowLength_tFileInputExcel_6 = 12;
							...
							try {
								...
								if (temp_row_tFileInputExcel_6[columnIndex_tFileInputExcel_6].length() > 0) {
									...
									row6.nb_jours_total = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_6[columnIndex_tFileInputExcel_6], null,
											'.' == decimalChar_tFileInputExcel_6 ? null
													: decimalChar_tFileInputExcel_6));
								} else {
								...
								if (temp_row_tFileInputExcel_6[columnIndex_tFileInputExcel_6].length() > 0) {
									curColNum_tFileInputExcel_6 = columnIndex_tFileInputExcel_6
											+ start_column_tFileInputExcel_6 + 1;
									curColName_tFileInputExcel_6 = "nb_d_heures_total";

									row6.nb_d_heures_total = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_6[columnIndex_tFileInputExcel_6], null,
											'.' == decimalChar_tFileInputExcel_6 ? null
													: decimalChar_tFileInputExcel_6));
								} else {
									row6.nb_d_heures_total = null;
									emptyColumnCount_tFileInputExcel_6++;
								}
...
// # Output table : 'OU6'
									OU6_tmp.Num_action = row6.Num_action;
									OU6_tmp.Intitule_de_l_action = row6.Intitule_de_l_action;
									OU6 = OU6_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU6.Num_action;
									row8.Intitule_de_l_action = OU6.Intitule_de_l_action;
...
// ###############################
// # Outputs initialization
				OU7Struct OU7_tmp = new OU7Struct();
// ###############################
				...
				try {
					...
					if (sheetList_tFileInputExcel_7.size() > 0) {
						...
						for (int i_tFileInputExcel_7 = begin_line_tFileInputExcel_7; i_tFileInputExcel_7 < end_line_tFileInputExcel_7; i_tFileInputExcel_7++) {
							...
							row7 = null;
							int tempRowLength_tFileInputExcel_7 = 12;
...
// # Output table : 'OU7'
									OU7_tmp.Num_action = row7.Num_action;
									OU7_tmp.Intitul__de_l_action = row7.Intitul__de_l_action;
									OU7 = OU7_tmp;
// ###############################
...
// for output
									...
									row8.Num_action = OU7.Num_action;
									row8.Intitule_de_l_action = OU7.Intitul__de_l_action;
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "OU5", "OU6", "OU7", "OU2", "OU4", "ou1", "OU3");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "INSERT_DIM_ACTION");
				}
	...
	public static void main(String[] args) {
		final dim_action1 dim_action1Class = new dim_action1();

		int exitCode = dim_action1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_action1.class.getClassLoader()
					.getResourceAsStream("rh/dim_action1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_action1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_action1");
		}
...
/************************************************************************************************
 * 301717 characters generated by Talend Open Studio for Data Integration on the
 * 19 mars 2024 à 12:34:08 WAT
 ************************************************************************************************/